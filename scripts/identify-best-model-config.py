            ...
            for fold_dir in fold_dirs:
                ...
                if os.path.exists(model_train_performance_path) and os.path.isfile(model_validation_performance_path):
                    ...
                    fold_train_errors.append(100 - 
                        (model_train_performance[model_train_performance['epoch']==best_epoch]['accuracy'].values[0]*100) )
                    fold_validation_errors.append(100 - 
                        (model_validation_performance[model_validation_performance['epoch']==best_epoch]['accuracy'].values[0]*100) )
